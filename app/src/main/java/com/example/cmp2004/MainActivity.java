...
import com.example.cmp2004.image.ImageClassificationActivity;
import com.example.cmp2004.object.FaceDetectionActivity;
import com.example.cmp2004.object.FaceRecognitionActivity;
import com.example.cmp2004.object.PoseDetectionActivity;
import com.example.cmp2004.object.VisitorAnalysisActivity;
...
public class MainActivity extends AppCompatActivity implements AlgoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Algo(R.drawable.baseline_portrait_black_48, "Pose Detection", PoseDetectionActivity.class));
        arrayList.add(new Algo(R.drawable.baseline_portrait_black_48, "Face Analysis", VisitorAnalysisActivity.class));
